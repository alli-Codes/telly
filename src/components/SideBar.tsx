...
const SideBar = function ({isSideBarMinimized, handleSideBarMinimizing}: Props) {
    ...
    return (
        <div className={`h-[100vh] max-w-56 py-16 flex flex-col gap-20 bg-white rounded transition-all duration-500 ease-in	sticky top-0 z-10 ${isSideBarMinimized ? 'menu__maximized' : 'menu__minimized'}`}>
